...
public class DatabaseChangeLog {
  ...
  public void seedDatabase(ProductDao productDao) {
    ...
    productList.add(
        ProductEntity.builder()
            .productId(300L)
            .name("Darlah Firwood Table - Christopher Knight Home")
            .price(38.39)
            .currency("USD")
            .build());
    productList.add(
        ProductEntity.builder()
            .productId(400L)
            .name("Urban Industrial Farmhouse Metal X Entry Table - Saracina Home")
            .price(152.99)
            .currency("USD")
            .build());
    productList.add(
        ProductEntity.builder()
            .productId(500L)
            .name("8pc Foam Paint Brush Variety Pack - Hand Made Modern®")
            .price(1.49)
            .currency("USD")
            .build());
    productList.add(
        ProductEntity.builder()
            .productId(600L)
            .name("Unfinished Natural Wood Tray Small - Hand Made Modern")
            .price(7.99)
            .currency("USD")
            .build());
